...
function antiMat($text)
{
    ...
    foreach ($matArr as $mat) {
        $text = str_replace($mat, '[conserned]', $text);
    }
    return $text;
}
...
if ($_POST['action'] == 'add_comment') {
    $data = $_POST;
    $data['username'] = antiMat($data['username']);
        ...
        <div class="container">
            <div class="wrapper">
                <form action="" method="post" name="Login_Form" class="form-signin">
                    ...
                    <textarea  style="width: 100%;" placeholder="Your message" name="comment"></textarea>
                ...
                foreach ($content as $comment)  : ?>
                    <div style="border: 1px solid black;
                             padding: 1em;
margin-bottom: 1em;">
                   <h3 style="color: #0000bf"><?= $comment['username'] ?> <br></h3>
                    <?= $comment['header'] ?> <br>
                    <?= $comment['comment'] ?> <br><br><br></div>
                <?php  endforeach; ?>
