...
$content = $economyArray[$id]['content'];
if ($economyArray[$id]['analitics'] == 1 && (!isset( $_SESSION['user_email']))) {
    $arr = explode('</div>', $economyArray[$id]['content']);
...
<div class="container marketing">
    ...
    <div class="row featurette">
        <div class="col-md-7">
            <h2 class="featurette-heading"><?= $economyArray[$id]['name'] ?></h2>
            <p class="lead"><?= $content ?></p>
            <h4>Теги: <a href="economy.php"><?= $economyArray[$id]['section'] ?></a></h4>
        </div>
        <div class="col-md-5">
            <img class="featurette-image img-responsive" src="../images/<?= $economyArray[$id]['image'] ?>">
        </div>
